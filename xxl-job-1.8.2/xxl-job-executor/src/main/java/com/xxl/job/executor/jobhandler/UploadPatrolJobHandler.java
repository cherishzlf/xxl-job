 ...
 * @version 1.8.2
 */
@JobHander(value = "uploadPatrolJobHandler")
@Service
public class UploadPatrolJobHandler extends IJobHandler {
    /**
     * 巡查上报服务
    ...
    public ReturnT<String> execute(String... params) throws Exception {
        ...
        UpParolerecord firstUpParolerecord = mdLocusrecordService.getFirstParolerecord(condition);
 ...
 /*       Date nowdate = new Date();
        ...
        if (isFirstUpload == true) {
            mdLocusrecordVOList = mdLocusrecordService.getLocusrecordForUpload(condition);
        }else{
        ...
        if(!idList.isEmpty()) {
            ...
            mdLocusrecordService.updateUploadtime(entity);
        }
