...
public class WaterqualityMonthly {
    ...
    public String toString() {
        return "WaterqualityMonthly [uid=" + uid + ", code=" + code + ", rivername=" + rivername + ", sectionname="
                ...
                + ", conductance=" + conductance + ", turbidity=" + turbidity + ", waterlevel=" + waterlevel
                + ", statisticaltime=" + statisticaltime + ", lx=" + lx + ", wt=" + wt + ", dipany=" + dipany
                + ", dopd=" + dopd + ", codmnpd=" + codmnpd + ", nh4npd=" + nh4npd + ", tppd=" + tppd + ", totalpd="
                + totalpd + ", year=" + year + ", month=" + month + ", remark=" + remark + ", timestamp=" + timestamp
                + "]";
    }    
}
